...
contract GovernanceConstants {
    ...
    uint256 internal constant _MIN_LEFTOVER_REFERRAL_SHARE = 20e18; // 20%
    ...
    uint256 internal constant _MAX_LEFTOVER_REFERRAL_SHARE = 100e18; // 100%
    ...
    uint256 internal constant _DEFAULT_LEFTOVER_REFERRAL_SHARE = 100e18; // 100%
}
