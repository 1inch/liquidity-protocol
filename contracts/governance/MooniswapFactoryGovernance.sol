...
contract MooniswapFactoryGovernance is IMooniswapFactoryGovernance, BaseGovernanceModule, MooniswapConstants, BalanceAccounting, Ownable {
    ...
    event DefaultSlippageFeeVoteUpdate(address indexed user, uint256 fee, bool isDefault, uint256 amount);
    ...
    event GovernanceShareVoteUpdate(address indexed user, uint256 referralShare, bool isDefault, uint256 amount);
